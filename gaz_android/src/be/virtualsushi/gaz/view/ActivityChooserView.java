 ...
 */
package be.virtualsushi.gaz.view;
...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
	...
	private void showPopupUnchecked(int maxActivityCount) {
		...
		if (maxActivityCount != ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED && activityCount > maxActivityCount) {
	 ...
	 */
	private class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, PopupWindow.OnDismissListener {
