...
import be.virtualsushi.gaz.view.ActivityChooserView;
 ...
 * 
 * <p class="note">
 * <strong>Note:</strong> This class is included in the <a href="{@docRoot}
 * tools/extras/support-library.html">support library</a> for compatibility with
 * API level 7 and higher. If you're developing your app for API level 14 and
 * higher <em>only</em>, you should instead use the framework
 ...
 * 
 * <p>
 * For information about how to use {@link ShareActionProvider}, see the
 * <a href="{@docRoot}, see the <a
 * href="{@docRoot}, see the <a
 * href="{@docRoot}, see the <a href="{@docRoot}
 * guide/topics/ui/actionbar.html#ActionProvider">Action Bar</a> API guide.
 * </p>
 * </div>
 * 
 * @see ActionProvider
...
public class ShareActionProvider extends ActionProvider {
	...
	public interface OnShareTargetSelectedListener {
		 ...
		 * whether to perform some action before the sharing is actually
		 * performed.
		 * <p>
		 ...
		 * intent here. This callback aims to notify the client that a sharing
		 * is being performed, so the client can update the UI if necessary.
		 * </p>
		 * 
		 * @param source
		 ...
		 * @return The return result is ignored. Always return false for
		 *         consistency.
		 */
